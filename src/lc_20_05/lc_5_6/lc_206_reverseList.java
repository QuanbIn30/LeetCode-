...
public class lc_206_reverseList {
    ...
    public static void main(String[] args) {
        ...
        l1.next.next.next.next = new ListNode(23);
        l1.next.next.next.next.next = new ListNode(17);
        l1.next.next.next.next.next.next = new ListNode(33);

//        ListNode res = reverseList3(l1);
        ListNode res = reverseList1(l1);
